...
public sealed class PatientProfileConfiguration : IEntityTypeConfiguration<PatientProfile>
{
    public void Configure(EntityTypeBuilder<PatientProfile> builder)
    {
        ...
        builder
            .Property(x => x.MedicalRecordNumber)
        ...
        builder.Property(x => x.DocumentNumber).HasColumnName("document_number").HasMaxLength(50);
        ...
        builder.Property(x => x.EthnicityId).HasColumnName("ethnicity_id");

        builder.Property(x => x.BloodTypeId).HasColumnName("blood_type_id");

        builder
            .Property(x => x.PhoneCountryCode)
        ...
        builder.Property(x => x.Address).HasColumnName("address").HasMaxLength(200);
        ...
        builder
            .Property(x => x.LeagueNickname)
            .HasColumnName("league_nickname")
            .HasMaxLength(32);

        builder.Property(x => x.LeagueOptIn).HasColumnName("league_opt_in").HasDefaultValue(false);
        ...
        builder.Property(x => x.MemberId).HasColumnName("member_id").HasMaxLength(50);

        builder.Property(x => x.MaritalStatus).HasColumnName("marital_status").HasMaxLength(30);

        builder.Property(x => x.SmokingStatus).HasColumnName("smoking_status").HasMaxLength(30);

        builder.Property(x => x.AlcoholStatus).HasColumnName("alcohol_status").HasMaxLength(30);

        builder.Property(x => x.ExerciseLevel).HasColumnName("exercise_level").HasMaxLength(30);

        builder.Property(x => x.Disability).HasColumnName("disability").HasMaxLength(30);

        builder
            .Property(x => x.HospitalizationHistory)
            .HasColumnName("hospitalization_history")
            .HasMaxLength(30);

        builder.Property(x => x.SurgeryHistory).HasColumnName("surgery_history").HasMaxLength(100);
        ...
        builder.Property(x => x.ClinicId).HasColumnName("clinic_id");
        ...
        builder.HasIndex(x => x.UserId).HasDatabaseName("ix_patient_profiles_user_id").IsUnique();
        ...
        builder.HasIndex(x => x.Status).HasDatabaseName("ix_patient_profiles_status");

        builder.HasIndex(x => x.ClinicId).HasDatabaseName("ix_patient_profiles_clinic_id");

        builder.HasIndex(x => x.LocationId).HasDatabaseName("ix_patient_profiles_location_id");

        builder.HasIndex(x => x.DeletedAt).HasDatabaseName("ix_patient_profiles_deleted_at");
        ...
        builder.HasIndex(x => x.CityId).HasDatabaseName("ix_patient_profiles_city_id");

        builder.HasIndex(x => x.StateId).HasDatabaseName("ix_patient_profiles_state_id");
