...
namespace CoppAddresd.Infrastructure.Migrations
{
    ...
    [Migration("20260924183849_AddRedesModule")]
    partial class AddRedesModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.BiometriaDailyMetric", b =>
                {
                    ...
                    b.HasIndex("MetricKey", "MetricDate")
                        .HasDatabaseName("ix_biometria_daily_metrics_metric_key_metric_date");

                    b.ToTable("biometria_daily_metrics", "app");
                });
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.CptCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.HealthTests.HealthTestGeoRollup", b =>
                {
                    ...
                    b.Property<long>("ActiveAlertsCount")
                        .HasColumnType("bigint")
                        .HasColumnName("active_alerts_count");

                    b.Property<long>("AvgScoreCount")
                        .HasColumnType("bigint")
                        .HasColumnName("avg_score_count");

                    b.Property<decimal>("AvgScoreSum")
                        .HasColumnType("numeric(14,4)")
                        .HasColumnName("avg_score_sum");
                    ...
                    b.Property<long>("EvaluatedCount")
                        .HasColumnType("bigint")
                        .HasColumnName("evaluated_count");

                    b.Property<long>("HighRiskCount")
                        .HasColumnType("bigint")
                        .HasColumnName("high_risk_count");

                    b.Property<long>("PatientsCount")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("health_test_geo_rollups", "app");
                });
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.FacturaRed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ModalidadContrato")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("modalidad_contrato");
                    ...
                    b.Property<string>("PeriodoAtencion")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("periodo_atencion");

                    b.Property<string>("PrestadorNit")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("prestador_nit");

                    b.Property<string>("PrestadorRazonSocial")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("prestador_razon_social");

                    b.Property<string>("RegistrosJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<decimal>("ValorCopago")
                        ...
                        .HasColumnName("valor_copago");

                    b.Property<decimal>("ValorCuotaModeradora")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("valor_cuota_moderadora");
                    ...
                    b.HasIndex("Estado")
                        .HasDatabaseName("ix_facturas_rips_estado");

                    b.HasIndex("PrestadorNit")
                        .HasDatabaseName("ix_facturas_rips_prestador_nit");

                    b.ToTable("facturas_rips", "erp");
                });

            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.FacturaRedArchivo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FacturaId")
                        .HasDatabaseName("ix_facturas_rips_archivos_factura_id");

                    b.ToTable("facturas_rips_archivos", "erp");
                });

            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.RadicacionRed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("CotizacionMonto")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("cotizacion_monto");

                    b.Property<string>("CotizacionNombreArchivo")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("cotizacion_nombre_archivo");

                    b.Property<string>("CotizacionNumero")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("cotizacion_numero");
                    ...
                    b.HasIndex("Estado")
                        .HasDatabaseName("ix_radicaciones_estado");

                    b.HasIndex("Nit")
                        .HasDatabaseName("ix_radicaciones_nit");

                    b.ToTable("radicaciones", "erp");
                });

            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.RadicacionRedLinea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("RadicacionId")
                        .HasColumnType("uuid")
                        .HasColumnName("radicacion_id");
                    ...
                    b.HasIndex("RadicacionId")
                        .HasDatabaseName("ix_radicacion_cups_radicacion_id");

                    b.ToTable("radicacion_cups", "erp");
                });

            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.RedPrestadora", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CodigoPrestador")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("codigo_prestador");
                    ...
                    b.ToTable("redes_prestadoras", "erp");
                });
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.FacturaRedArchivo", b =>
                {
                    b.HasOne("CoppAddresd.Domain.Entities.Redes.FacturaRed", null)
                        .WithMany("Archivos")
            ...
            modelBuilder.Entity("CoppAddresd.Domain.Entities.Redes.RadicacionRedLinea", b =>
                {
                    b.HasOne("CoppAddresd.Domain.Entities.Redes.RadicacionRed", null)
                        .WithMany("Lineas")
                        .HasForeignKey("RadicacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
