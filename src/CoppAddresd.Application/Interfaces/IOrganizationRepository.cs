...
public interface IOrganizationRepository
{
    ...
    Task<Organization> AddOrganizationAsync(Organization organization, CancellationToken ct = default);
    ...
    Task<IReadOnlyList<ProfessionalType>> ListProfessionalTypesAsync(CancellationToken ct = default);
    ...
    Task<IReadOnlyList<Specialty>> ListSpecialtiesByProfessionalTypeAsync(Guid professionalTypeId, CancellationToken ct = default);
